...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/aibizlab-hub/family-reminder-cloud/master/local-reminder-service.js" -OutFile $SVC_JS -ErrorAction Stop
